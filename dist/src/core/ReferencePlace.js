...
exports.ReferencePlace = exports.VALID_REF_PLACE_CLASSES = exports.NO_REFERENCE_PLACE = void 0;
/** Fallback description returned when no mapping exists for a class/type pair. */
exports.NO_REFERENCE_PLACE = 'Não classificado';
/**
 ...
 */
exports.VALID_REF_PLACE_CLASSES = Object.freeze([
    'place',
    'shop',
    'amenity',
    'railway',
...
class ReferencePlace {
    ...
    calculateDescription() {
        if (!this.className || !this.typeName) {
            return exports.NO_REFERENCE_PLACE;
        }
        if (!exports.VALID_REF_PLACE_CLASSES.includes(this.className)) {
            return exports.NO_REFERENCE_PLACE;
        }
...
exports.ReferencePlace = ReferencePlace;
/**
...
exports.default = ReferencePlace;
