...
class GeoPosition {
    ...
    constructor(position) {
        if (position !== null && typeof position !== 'object') {
            throw new errors_js_1.GeoPositionError(`GeoPosition: position must be an object, got ${typeof position}`);
        }
    ...
    distanceTo(otherPosition) {
        ...
        return (0, distance_js_1.calculateDistance)(this.latitude, this.longitude, otherPosition.latitude, otherPosition.longitude);
    }
    /**
