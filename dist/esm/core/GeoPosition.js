...
class GeoPosition {
    ...
    constructor(position) {
        if (position !== null && typeof position !== 'object') {
            throw new GeoPositionError(`GeoPosition: position must be an object, got ${typeof position}`);
        }
    ...
    distanceTo(otherPosition) {
        ...
        return calculateDistance(this.latitude, this.longitude, otherPosition.latitude, otherPosition.longitude);
    }
    /**
