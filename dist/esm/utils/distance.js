...
export const calculateDistance = (lat1, lon1, lat2, lon2) => {
    if (lat1 < -90 || lat1 > 90)
        throw new GeoPositionError(`calculateDistance: lat1 (${lat1}) is out of range [-90, 90]`);
    if (lat2 < -90 || lat2 > 90)
        throw new GeoPositionError(`calculateDistance: lat2 (${lat2}) is out of range [-90, 90]`);
    if (lon1 < -180 || lon1 > 180)
        throw new GeoPositionError(`calculateDistance: lon1 (${lon1}) is out of range [-180, 180]`);
    if (lon2 < -180 || lon2 > 180)
        throw new GeoPositionError(`calculateDistance: lon2 (${lon2}) is out of range [-180, 180]`);
